...
$(".row").css({"border": "solid double 1px black", "border-style": "double", "padding": "20px"});
...
$("li:has(em)").css({"border": "1px solid red"});
...
$("b:only-child").css({"font-size": "36px"});
...
$(".mbox > div").last().css({"padding-top": "50px"});
// for first div wraper for img set float left and border red
$(".mbox > div > img").first().css({"float": "left", "border": "1px solid red"});